...
function SignUp(props) {
    ...
    const signRef  = /** @type {import('react').MutableRefObject<HTMLFormElement>} */ (useClickAway(() => {
    ...
    function validatePassword() {
        ...
        const confirm_password = credentials?.cpassword;
        const confirmPasswordInput = /** @type {HTMLInputElement | null} */ (document.getElementById("password3"));
        if (password && confirm_password && confirmPasswordInput) {
    ...
    const closeModal = () => {
        const form = /** @type {HTMLFormElement | null} */ (document.getElementById("sign-form"));
        if (form) {
            form.reset();
        }
        setDisplaySignUp(false)
